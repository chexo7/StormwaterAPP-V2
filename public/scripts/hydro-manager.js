        ...
        function openPopup(p,pos){
            ...
            if(isDrainage){
                ...
                d.innerHTML=`
                    ...
                    <div class="flex justify-end gap-2">
                        <button id="popup-save" class="px-3 py-1 text-xs bg-indigo-600 text-white rounded shadow hover:bg-indigo-700" ${missingDP?'disabled':''}>Guardar</button>
                        <button id="popup-close" class="px-3 py-1 text-xs border rounded text-slate-600 hover:bg-slate-50">Cerrar</button>
                    </div>
                `;
            }
            ...
            if(saveBtn){
                saveBtn.addEventListener('click',()=>{
                    ...
                    if(isSub){
                        ...
                        if(daSel && p.feature && !daSel.disabled){
