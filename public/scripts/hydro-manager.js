// --- LOGGING ---
        ...
        async function initMap() {
            ...
            try {
                ...
                map = new Map(document.getElementById("map"), { center: { lat: 39.8283, lng: -98.5795 }, zoom: 4, disableDefaultUI: true, zoomControl: false, gestureHandling: 'greedy', styles: [{"featureType":"poi","stylers":[{"visibility":"off"}]}] });
